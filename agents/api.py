"""
FastAPI REST API Server for Pd L1 Tps Cps Scorer.
"""
...
app = FastAPI(
    title="Pd L1 Tps Cps Scorer API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "pd-l1-tps-cps-scorer", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
