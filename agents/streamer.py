"""
Live WebSocket Distributed Component Telemetry Streamer for pd-l1-tps-cps-scorer.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "pd-l1-tps-cps-scorer", "event_type": event_type, "payload": data})
